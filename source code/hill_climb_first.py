...
sample_size = 30
dimensions = [5, 10, 30]
output_file = "hc_first_david.txt"
...
def first_hc(fnc, interval, n, iters, lock, seed, smpl_sz):
    smpl_sz = int(smpl_sz)
    print(f'started process {seed} sample size = {smpl_sz}, iterations = {iters}')
    np.random.seed(seed)
